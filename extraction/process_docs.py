...
class DocumentationProcessor:
    ...
    def add_module(self, name: str = None, description: str = "", dev_path: str = None, user_path: str = None, methodology_path: str = None, module_name: str = None, url_for_sources_citation: str = ""):
    ...
    def extract_content_doxygen(self, soup: BeautifulSoup) -> Dict:
        ...
        if contents:
            for tag in contents.find_all(['script', 'style', 'noscript']):
                tag.decompose()
            content_dict['content'] = html_to_markdown(contents)
        else:
            body = soup.find('body')
            if body:
    ...
    def extract_content_sphinx(self, soup: BeautifulSoup) -> Dict:
        ...
        for area in content_areas:
            if area:
                ...
                content_dict['content'] = html_to_markdown(area)
                break
